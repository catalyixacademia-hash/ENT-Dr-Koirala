...
const ENT_REASONS_EN = [
  ...
  'Sore Throat / Tonsil Issues',
  'Voice Change / Hoarseness',
  'Pediatric ENT Concern',
...
const ENT_REASONS_NE = [
  'कान दुख्ने / कान संक्रमण',
  'श्रवण हानि / टिनिटस',
  'बन्द / बग्ने नाक',
  'साइनसाइटिस / साइनस दबाब',
  'घाँटी दुख्ने / टन्सिल समस्या',
  'आवाज परिवर्तन / कर्कश',
  'बाल ENT समस्या',
  'एलर्जी परामर्श',
  'शल्यक्रिया पछिको फलो-अप',
  'श्रवण यन्त्र मूल्यांकन',
  'अन्य ENT समस्या',
];
...
export default function BookingSection({ language }: BookingSectionProps) {
  ...
  const validate = () => {
    ...
    if (!formData.fullName)
      newErrors.fullName = language === 'ne' ? 'पूरा नाम आवश्यक छ' : 'Full name is required';
    if (!formData.phone)
      newErrors.phone = language === 'ne' ? 'फोन नम्बर आवश्यक छ' : 'Phone number is required';
    if (!formData.preferredDate)
      newErrors.preferredDate = language === 'ne' ? 'मिति छान्नुहोस्' : 'Please select a date';
    if (!formData.preferredTime)
      newErrors.preferredTime = language === 'ne' ? 'समय छान्नुहोस्' : 'Please select a time slot';
    if (!formData.reason)
      newErrors.reason = language === 'ne' ? 'कारण छान्नुहोस्' : 'Please select a reason';
    return newErrors;
  };
  ...
  const INFO_ITEMS = [
    {
      id: 'info-phone',
      icon: 'PhoneIcon',
      label: language === 'ne' ? 'फोन' : 'Phone',
      value: '061-553150 | 985-6034347 | 9846166733',
    },
    {
      id: 'info-addr',
      icon: 'MapPinIcon',
      label: language === 'ne' ? 'क्लिनिक ठेगाना' : 'Clinic Address',
      value:
        language === 'ne'
          ? 'नयाबजार ENT केयर सेन्टर / श्री कृष्ण ENT केयर, नयाबजार, पोखरा, नेपाल'
          : 'Nayabazar ENT Care Center / Shree Krishna ENT Care, Nayabazar, Pokhara, Nepal',
    },
    {
      id: 'info-hours',
      icon: 'ClockIcon',
      label: language === 'ne' ? 'क्लिनिक समय' : 'Clinic Hours',
      value:
        language === 'ne'
          ? 'सोम–शनि: बिहान ९:०० – १:०० र साँझ ५:०० – ८:००'
    ...
    },
    {
      ...
      icon: 'GlobeAltIcon',
      label: 'Facebook',
      value: 'facebook.com/drkrishnakoirala',
    },
  ];
          ...
          <div>
            ...
            <div className="space-y-3 sm:space-y-4 mb-8">
              {INFO_ITEMS.map((item) => (
                <div
                  key={item.id}
                  className="flex items-start gap-3 sm:gap-4 bg-white rounded-xl p-3 sm:p-4 border card-shadow"
                >
            ...
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="btn-primary w-full py-3.5 sm:py-4 text-sm sm:text-base"
                >
                  {loading ? (
                    <>

...
const POSTS = [
  {
    ...
    excerpt:
      'Many ENT conditions are ignored until they become serious. Here are the key symptoms that warrant immediate specialist attention.',
  ...
  },
  {
    ...
    excerpt:
      'The symptoms overlap, but the treatments are very different. Learn how to distinguish between a cold and a sinus infection.',
    category: 'Sinus & Nose',
    readTime: '3 min read',
    date: 'May 5, 2026',
  ...
  },
  {
    ...
    excerpt:
      "From loud environments to ear infections, here's what every parent needs to know about preserving their child's hearing health.",
    category: 'Pediatric ENT',
    readTime: '5 min read',
    date: 'Apr 28, 2026',
    image: 'https://img.rocket.new/generatedImages/rocket_gen_img_18776e785-1769256827151.png',
    imageAlt:
      'Happy child getting ear examination from friendly pediatric ENT doctor in colorful clinic',
            ...
            >
              ...
              <div className="p-5">
                <div className="flex items-center gap-3 mb-3">
                  <span
                    className={`px-2.5 py-1 rounded-full text-xs font-bold ${post?.categoryColor}`}
                  >
                    {post?.category}
                  </span>

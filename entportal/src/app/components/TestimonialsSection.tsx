    ...
    <section className="section-padding bg-white">
      <div className="max-w-screen-xl mx-auto px-6 lg:px-8">
        ...
        <div className="max-w-3xl mx-auto">
          <div
            className="bg-muted/30 rounded-3xl p-8 lg:p-12 border relative animate-fade-in"
            key={active?.id}
          >
            {/* Quote mark */}
            <div className="absolute top-6 right-8 text-8xl font-serif text-primary/10 leading-none select-none">
              "
            </div>

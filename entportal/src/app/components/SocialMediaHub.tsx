      ...
      <div className="max-w-screen-xl mx-auto px-6 lg:px-8">
        <div className="text-center mb-14">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Follow for ENT tips, myth-busting videos, and patient education content in Nepali —
            making ENT health accessible for everyone in Western Nepal and beyond.
          </p>
        </div>
            ...
            >
              ...
              <div className="relative">
                <div className="flex items-center justify-between mb-4">
                  <Icon
                    name={platform.icon as Parameters<typeof Icon>[0]['name']}
                    size={28}
                    className="text-white"
                  />
                  <span className="text-white/70 text-xs font-medium">{platform.platform}</span>
                </div>
                <p className="text-3xl font-extrabold text-white font-tabular mb-1">
                  {platform.followers}
                </p>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="p-3 flex items-center justify-between">
                      ...
                      <span className="ml-2 shrink-0 px-2 py-0.5 rounded-full text-xs font-bold bg-red-100 text-red-600">
                        {video.platform}
                      </span>
                    </div>
                  </div>
        ...
        <div className="text-center">
          <p className="text-muted-foreground text-sm mb-4">
            Watch short ENT tips & awareness videos — new content regularly
          </p>

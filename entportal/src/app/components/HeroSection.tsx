...
export default function HeroSection({ language }: HeroSectionProps) {
  ...
  return (
    <section
      ...
      style={{ background: 'linear-gradient(135deg, #075985 0%, #0f766e 60%, #115e59 100%)' }}
    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center py-12 lg:py-16">
          ...
          <div className="animate-slide-up order-2 lg:order-1">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl xl:text-6xl font-extrabold text-white leading-tight tracking-tight mb-5 lg:mb-6 text-balance">
              {t.hero_title}
              <br />
              <span className="text-emerald-300">{t.hero_title_accent}</span>
            </h1>
            ...
            <div className="flex flex-wrap gap-3 lg:gap-4 mb-8 lg:mb-10">
              <a
                href="#booking"
                className="inline-flex items-center gap-2 px-5 sm:px-7 py-3 sm:py-3.5 rounded-xl font-bold text-sm text-[#0f766e] transition-all duration-200 active:scale-95 bg-white hover:bg-emerald-50 hover:shadow-xl"
              >
            ...
            <div className="flex flex-wrap gap-3 lg:gap-4">
              {TRUST_BADGES.map((badge) => (
                <div
                  key={badge.id}
                  className="flex items-center gap-3 bg-white/10 border border-white/20 rounded-xl px-3 sm:px-4 py-2.5 sm:py-3"
                >
                  <div className="w-8 h-8 sm:w-9 sm:h-9 rounded-lg bg-emerald-400/20 flex items-center justify-center flex-shrink-0">
                    <Icon
                  ...
                  <div>
                    <p className="text-white font-bold text-base sm:text-lg leading-none font-tabular">
                      {badge.value}
                    </p>
          ...
          <div className="relative flex justify-center lg:justify-end order-1 lg:order-2">
            <div className="relative w-64 h-80 sm:w-80 sm:h-96 lg:w-96 lg:h-[480px]">
              ...
              />
              <div
                className="relative w-full h-full rounded-3xl overflow-hidden border-2 border-white/20"
                style={{
                  background:
                    'linear-gradient(180deg, rgba(16,185,129,0.2) 0%, rgba(15,118,110,0.4) 100%)',
                }}
              >
                <AppImage
              ...
              {/* Floating card */}
              <div className="absolute -bottom-4 sm:-bottom-6 -left-4 sm:-left-6 bg-white rounded-2xl p-3 sm:p-4 shadow-2xl border border-emerald-100">
                <div className="flex items-center gap-2 sm:gap-3">
                  <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-xl bg-emerald-600 flex items-center justify-center flex-shrink-0">
                    <Icon name="CheckBadgeIcon" size={18} className="text-white" />
                  </div>
                  <div>
                    <p className="text-xs font-bold text-slate-900">{t.hero_float_title}</p>
              ...
              {/* Rating card */}
              <div className="absolute -top-3 sm:-top-4 -right-3 sm:-right-4 bg-white rounded-2xl px-3 sm:px-4 py-2 sm:py-3 shadow-2xl border border-emerald-100">

...
export const MOCK_PATIENTS: Patient[] = [
  {
    ...
    visitCount: 8,
    diagnosisTags: ['Sinusitis', 'Nasal Polyps'],
    allergies: ['Dust Mites', 'Pollen'],
    notes: 'Post-FESS patient. Monitor for polyp recurrence every 3 months.',
    status: 'active',
  ...
  },
  {
    ...
    visitCount: 3,
    diagnosisTags: ['Otitis Media'],
    allergies: [],
    notes: 'Recurrent ear infections. 3rd episode in 12 months. Consider myringotomy.',
    status: 'active',
    registeredOn: '2025-11-05',
  },
  {
    id: 'pat-003',
    name: 'Neha Joshi',
    ...
    visitCount: 1,
    diagnosisTags: ['Tonsillitis'],
    allergies: ['Penicillin'],
    notes: 'New patient. Chronic tonsillitis. Discuss tonsillectomy candidacy.',
    status: 'active',
    registeredOn: '2026-05-17',
  },
  {
    id: 'pat-004',
    name: 'Amir Khan',
    ...
    visitCount: 12,
    diagnosisTags: ['SNHL', 'Tinnitus'],
    allergies: ['NSAIDs'],
    notes:
      'Bilateral sensorineural hearing loss. Hearing aid fitting in progress. Avoid loud environments.',
    status: 'active',
  ...
  },
  {
    ...
    visitCount: 5,
    diagnosisTags: ['Allergic Rhinitis'],
    allergies: ['Cat Dander', 'Mold'],
    notes: 'Seasonal allergic rhinitis. Immunotherapy started April 2026.',
    status: 'active',
    registeredOn: '2025-04-15',
  },
  {
    id: 'pat-006',
    name: 'Vikram Singh',
    ...
    nextAppointment: '2026-05-18',
    visitCount: 6,
    diagnosisTags: ['Tympanic Perforation'],
    allergies: [],
    notes: 'Post-tympanoplasty. 2-week follow-up scheduled. No water in ear.',
    status: 'active',
  ...
  },
  {
    ...
    nextAppointment: '2026-05-18',
    visitCount: 9,
    diagnosisTags: ['Nasal Polyps', 'CRS'],
    allergies: ['Aspirin'],
    notes: 'Recurrent nasal polyps despite steroid sprays. Surgical intervention being planned.',
    status: 'active',
  ...
  },
  {
    ...
    visitCount: 4,
    diagnosisTags: ['Otitis Media', 'Adenoid Hypertrophy'],
    allergies: [],
    notes: 'Pediatric patient. Parents: Sundar & Kavya Thapa. Ear tubes placed April 2026.',
    status: 'active',
  ...
  },
  {
    ...
    nextAppointment: '2026-05-19',
    visitCount: 2,
    diagnosisTags: ['Acute Sinusitis'],
    allergies: [],
    notes: 'New booking online. First visit for sinusitis.',
    status: 'active',
  ...
  },
  {
    ...
    nextAppointment: null,
    visitCount: 7,
    diagnosisTags: ['Presbycusis', 'Tinnitus'],
    allergies: ['Gentamicin'],
    notes: 'Age-related hearing loss. Hearing aid trial ongoing. Avoid ototoxic medications.',
    status: 'inactive',
  ...
  },
  {
    ...
    nextAppointment: null,
    visitCount: 2,
    diagnosisTags: ['Vocal Cord Nodules'],
    allergies: [],
    notes: 'Walk-in patient. Referred to speech therapist. Follow-up in 6 weeks.',
    status: 'active',
  ...
  },
  {
    ...
    visitCount: 11,
    diagnosisTags: ['Allergic Rhinitis', 'Asthma'],
    allergies: ['Pollen', 'Dust', 'Cockroach'],
    notes: 'Immunotherapy month 3. Symptoms improving. Continue current protocol.',
    status: 'active',
    ...
    <div className="space-y-5 max-w-screen-2xl mx-auto">
      ...
      <div className="flex items-center justify-between flex-wrap gap-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-0.5">
            {patients.length} {t.admin_patients_in_db}
          </p>
        </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        {[
          ...
          <div
            key={s.id}
            className="bg-white rounded-2xl border card-shadow p-4 flex items-center gap-3"
          >
      ...
      <div className="bg-white rounded-2xl border card-shadow p-4 flex flex-wrap gap-3 items-center">
        ...
        <span className="ml-auto text-xs text-muted-foreground">
          {filtered.length} {t.admin_results}
        </span>
      </div>
